# CLAUDE.md — Claude Code entry point for `webship/webship-patches`
...
3. Code map: `src/Plugin/WebshipPatchesPlugin.php` (entry point + activation), `src/Resolver/` (allowlist + wildcard + `patches-ignore`), `src/Command/` (`web-ccup`, `web-ccupf`).
...
- **Do not link to private Webship repositories** from in-repo documentation. Only public artifacts: this repo, `docs.webship.webship.com`, `cweagans/composer-patches`, Drupal.org.
...
- `11.0.x` — Drupal 11 / Webship 11.
- `10.1.x` — Drupal 11 / Webship 10.1.
- `10.0.x` — Drupal 10 / Webship 10.
- `9.2.x` — Drupal 10 / Webship 9.2 (CKEditor 5).
- `9.1.x` — Drupal 10 / Webship 9.1 (CKEditor 4).
