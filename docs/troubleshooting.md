...
**Fix:** confirm the offending patch comes from a non-Webship dependency (see `Resolving patches from dependencies` log lines), then make sure your config keeps the default allowlist:
